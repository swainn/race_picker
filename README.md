...
A gamified random-selection tool with thirteen game modes — race cars, battle bots, light cycles, Plinko balls, wall climbers, a battleship grid, a spinning wheel, a kung-fu brawl, a retro Space Invaders assault (as the invaders or the defenders), a one-on-one Street Duel, an alien abduction, or a hand of poker — all sharing the same participant list.
